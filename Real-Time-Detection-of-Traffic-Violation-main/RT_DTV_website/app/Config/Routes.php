...
$routes->get('violation/history', 'ViolationController::history');
$routes->get('violation', 'ViolationController::index');
$routes->post('violation/save', 'ViolationController::save_violation');
$routes->post('violation/dismiss', 'ViolationController::dismiss');
